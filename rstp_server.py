...
def main():
    ...
    server.set_service("8554")  # Port 8554
    ...
    mounts.add_factory("/cam5", factory1)
    ...
    mounts.add_factory("/cam6", factory2)

    # 4. Start the Server
    server.attach(None)
    print("RTSP Server is running...")
    print("Stream 1: rtsp://192.168.0.158:8554/cam5")
    print("Stream 2: rtsp://192.168.0.158:8554/cam6")
